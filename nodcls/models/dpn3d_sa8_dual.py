...
class DPN(nn.Module):
    def __init__(self, cfg):
        ...
        self.last_planes = 3056
        self.layer5 = self._make_layer(768*2, 2048*2, 2, 128, stride=2)
        self.linear_sa = nn.Linear(7040, 2)
